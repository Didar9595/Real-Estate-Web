  ...
  return (
    <Stack sx={{ display: 'flex', alignItems: 'center', padding: '1em' }}>
            <Stack direction='column' spacing={3} sx={{ marginTop: '3em', width: '60%' }}>
                <Typography variant='h4' sx={{ fontFamily: 'poppins', fontWeight: 'bold', textAlign: 'center' }}>Update a Property Listing</Typography>
                ...
                <Button variant='contained' size='large' disabled={loading||uploading} sx={{ fontFamily: 'poppins', fontWeight: 'bold', color: 'white', background: '#444d5c' }} onClick={handleSubmit}>{loading ? 'Updating...' : 'Update Listing'}</Button>
